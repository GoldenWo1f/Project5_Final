...
<table id="list" class="first-table">
    <tr> <th>제목</th><td>${u.title}</td> <th>카테고리</th><td>${u.category}</td></tr>
    <tr> <th>날짜</th><td>${u.dday}</td> <th>장소</th><td>${u.location}</td> </tr>
    <tr> <th>시작시간</th><td>${u.starttime}</td> <th>종료시간</th><td>${u.endtime}</td></tr>
</table>
